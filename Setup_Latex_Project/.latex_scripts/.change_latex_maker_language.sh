...
echo latex babel language :
read lang
cat > $HOME/.latex_scripts/.make_latex_project.sh << 'first'
...
\usepackage[
first
echo $lang >> $HOME/.latex_scripts/.make_latex_project.sh
cat >> $HOME/.latex_scripts/.make_latex_project.sh << 'second'
]{babel}
\usepackage{amssymb}
\usepackage{amsmath}
\usepackage{hyperref}
